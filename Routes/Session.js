...
var cookieName = 'SimpleAuth'; // Cookie key for authentication tokens
...
// |duration|
// (though the router, below, will check anyway to prevent hacking),
// and will not be
...
// based on cookies,
// delete the Session if it has timed out, or attach the Session to
// |req| if it's current
